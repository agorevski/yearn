...
function App(): ReactElement {
  ...
  const appBaseUrl = import.meta.env.VITE_APP_BASE_URL || 'https://yearn.azurewebsites.net'
  ...
  const ogUrl = isVaultDetailPage
    ...
    : manifest.og || `${appBaseUrl}/og.png`
  const pageUri = isVaultDetailPage ? `${appBaseUrl}${asPath}` : manifest.uri || appBaseUrl
